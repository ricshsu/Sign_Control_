<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign_Ctrl.aspx.cs" Inherits="EDA_Sign.Sign_Ctrl" %>
...
<body class ="R_Child1">
    ...
    <div>
         <ext:Button ID="Button2" runat="server" Text="CSV 上傳">
            <DirectEvents>
    ...
    <!-- 新增資料-->
                        ...
                        <Items>
                            <ext:Panel ID="Panel3" runat="server" Border="false" ColumnWidth="1" Layout="ColumnLayout" BodyStyle="padding:5px">
                                <Items>
                                    <ext:TextField  ID="New_Customer_ID" runat="server" FieldLabel="Customer_ID" Name="New_Customer_ID"  Length="15" EnforceMaxLength = "true"  MaxLength = "15" AllowBlank ="false"/>
                                    <ext:TextField ID="New_Category" runat="server" FieldLabel="Category" Name="New_Category" EnforceMaxLength = "true"  MaxLength = "8" AllowBlank ="false" />
                                    <ext:TextField ID="New_Part" runat="server" FieldLabel="Part" Name="New_Part" EnforceMaxLength = "true"  MaxLength = "7" AllowBlank ="false"/>
                                    <ext:TextField ID="New_Part_Id" runat="server" FieldLabel="Part_Id" Name="New_Part_Id" AllowBlank ="false"  />
                                    <ext:TextField ID="New_Yield_Impact_Item" runat="server" FieldLabel="Yield_Impact_Item" Name="New_Yield_Impact_Item" EnforceMaxLength = "true"  MaxLength = "15" AllowBlank ="false"/>
                                    <ext:TextField ID="New_Key_Module" runat="server" FieldLabel="Key_Module" Name="New_Key_Module" EnforceMaxLength = "true"  MaxLength = "15" AllowBlank ="false" />
                                    <ext:TextField ID="New_Data_Source" runat="server" FieldLabel="Data_Source" Name="New_Data_Source" EnforceMaxLength = "true"  MaxLength = "10" AllowBlank ="false" />
                                    <ext:TextField ID="New_Critical_Item" runat="server" FieldLabel="Critical_Item" Name="New_Critical_Item" EnforceMaxLength = "true"  MaxLength = "50" AllowBlank ="false"/>
                                    <ext:TextField ID="New_EDA_Item" runat="server" FieldLabel="EDA_Item" Name="New_EDA_Item" AllowBlank ="false"  />
                                    <ext:TextField ID="New_MAIN_ID" runat="server" FieldLabel="MAIN_ID" Name="New_MAIN_ID" EnforceMaxLength = "true"  MaxLength = "2"  AllowBlank ="false" />
                                </Items>
